...
curl_setopt($ch, CURLOPT_URL, "https://voip.ms/api/v1/rest.php?api_username={$user}&api_password={$pass}&method={$method}&date_from=2010-09-07&date_to=2010-09-07&answered=1&timezone=-5");
$result = curl_exec($ch);
curl_close($ch);
