...
class VoIPms{
    ...
    function connectFAX($did, $account, $monthly, $setup, $minute, $next_billing = '', $dont_charge_setup = 0, $dont_charge_monthly = 0){
        $function = "connectFAX";
        $params = array(
            "params" => array(
                "api_username"        => $this->api_username,
    ...
    function createSubAccount(
        ...
        $reseller_client, $reseller_package, $reseller_nextbilling, $reseller_chargesetup, $send_bye, $record_calls,$language=''
    ){
        $function = "createSubAccount";
        $params = array(
            "params" => array(
    ...
    function delPhonebookGroup($group){
        $function = "delPhonebook";
        $params = array(
            "params" => array(
                "api_username"  => $this->api_username,
    ...
    function getCallerIDFiltering($filtering, $did){
    ...
    function getPhonebook($phonebook, $name, $group, $group_name){
    ...
    function getPhonebookGroup($group, $name){
        $function = "getPhonebookGroup";
        $params = array(
            "params" => array(
                "api_username"  => $this->api_username,
                "api_password"  => $this->api_password,
    ...
    function setDIDInfo(
        $did, $routing, $failover_busy, $failover_unreachable, $failover_noanswer,
        $voicemail, $pop, $dialtime, $cnam, $callerid_prefix, $note, $billing_type, $record_calls
    ){
        $function = "setDIDInfo";
        $params = array(
            "params" => array(
    ...
    function setPhonebook($phonebook, $speed_dial, $name, $number, $callerid, $note, $group){
    ...
    function setPhonebookGroup($name, $group, $members){
        $function = "setPhonebook";
        $params = array(
            "params" => array(
                "api_username"  => $this->api_username,
    ...
    function setSIPURI($sipuri,$uri,$description,$callerid_override,$callerid_e164){
        $function = "setSIPURI";
        $params = array(
            "params" => array(
                "api_username"      => $this->api_username,
    ...
    function setSubAccount(
        ...
        $internal_dialtime, $reseller_client, $reseller_package, $reseller_nextbilling, $reseller_chargesetup,$send_bye,$record_calls,$language=''
    ){
        $function = "setSubAccount";
        $params = array(
            "params" => array(
    ...
    function unconnectFAX($did, $routing){
        $function = "unconnectFAX";
        $params = array(
            "params" => array(
                "api_username"  => $this->api_username,
                "api_password"  => $this->api_password,
